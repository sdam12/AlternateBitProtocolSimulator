...
using namespace std;
    ...
    int main(int argc, char ** argv) {
        ...
        if (argc < 2) {
			...
			". Te program should be invoked as follow:";
        ...
        using info = cadmium::logger::logger<cadmium::logger::logger_info, cadmium::
        dynamic::logger::formatter<TIME>, oss_sink_provider>;
        using debug = cadmium::logger::logger<cadmium::logger::logger_debug, cadmium::
        dynamic::logger::formatter<TIME>, oss_sink_provider>;
        using state = cadmium::logger::logger<cadmium::logger::logger_state, cadmium::
        dynamic::logger::formatter<TIME>, oss_sink_provider>;
        ...
        /*******NETWORK********/
        /************************/
        cadmium::dynamic::modeling::Ports iports_Network = {typeid(inp_1),
	    typeid(inp_2)};
        cadmium::dynamic::modeling::Ports oports_Network = {typeid(outp_1),
	    typeid(outp_2)};
	    ...
	    NETWORK = std::make_shared<cadmium::dynamic::modeling::coupled<TIME>>(
            "Network", 
            submodels_Network, 
            iports_Network, 
            oports_Network, 
        ...
        cadmium::dynamic::modeling::EOCs eocs_ABPSimulator = {
            cadmium::dynamic::translate::make_EOC<Sender_defs::packetSentOut,outp_pack>
	    	("sender1"),
            cadmium::dynamic::translate::make_EOC<Sender_defs::ackReceivedOut,outp_ack>
	    	("sender1")
        };
        cadmium::dynamic::modeling::ICs ics_ABPSimulator = {
            cadmium::dynamic::translate::make_IC<Sender_defs::dataOut, inp_1>
	    	("sender1","Network"),
            cadmium::dynamic::translate::make_IC<outp_2, Sender_defs::ackIn>
	    	("Network","sender1"),
            cadmium::dynamic::translate::make_IC<Receiver_defs::out, inp_2>
	    	("receiver1","Network"),
            cadmium::dynamic::translate::make_IC<outp_1, Receiver_defs::in>
	    	("Network","receiver1")
        };
        ...
        cadmium::dynamic::modeling::Ports oports_TOP = {typeid(outp_pack),
	    typeid(outp_ack)};
        ...
        cadmium::dynamic::modeling::ICs ics_TOP = {
	    	...
	    	<Message_t>::out,inp_control>("generator_con","ABPSimulator")
        };
